...
import { Loader2, ArrowLeft, Smartphone, Mail, ScanLine } from 'lucide-react';
...
const LoginPage = ({ onLogin }: { onLogin: () => void }) => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    setIsLoading(true);
    try {
      // Here you would typically verify the OTP and referral code
      console.log(values);
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      {/* Animated Circles */}
      <motion.div
        className="absolute top-0 -left-4 w-80 h-80 bg-frog8-primary/10 rounded-full mix-blend-multiply filter blur-xl opacity-70"
        animate={{
          scale: [1, 1.2, 1],
          rotate: [0, 90, 0],
          x: [0, 20, 0],
      ...
      />
      <motion.div
        className="absolute top-0 -right-4 w-80 h-80 bg-frog8-primary/20 rounded-full mix-blend-multiply filter blur-xl opacity-70"
        animate={{
          scale: [1, 1.2, 1],
          rotate: [0, -90, 0],
          x: [0, -20, 0],
      ...
      />
      <motion.div
        className="absolute -bottom-8 left-20 w-80 h-80 bg-frog8-primary/15 rounded-full mix-blend-multiply filter blur-xl opacity-70"
        animate={{
          scale: [1, 1.2, 1],
          rotate: [0, 45, 0],
          y: [0, -20, 0],
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-4">
        <motion.div
          ...
          className="mb-8"
        >
          <img src="/F8_Logo.png" alt="Frog8 Logo" className="h-20 drop-shadow-md" />
        </motion.div>
              ...
              <Card className="border border-frog8-primary/20 shadow-xl backdrop-blur-sm bg-white/90 overflow-hidden">
                ...
                <CardContent className="space-y-6 pt-4">
                  <div className="p-6 bg-white rounded-lg shadow-inner border border-frog8-primary/10 relative">
                    ...
                    >
                      <ScanLine className="w-40 h-40 text-frog8-primary/10" />
                    </motion.div>
                    <QRCode 
                ...
                <CardHeader className="pb-2">
                  <div className="flex items-center justify-between">
                    <Button
                      ...
                      className="hover:bg-frog8-primary/10 text-frog8-primary rounded-full h-9 w-9"
                    >
                  ...
                  <CardDescription className="text-center pt-1">
                    Please enter your OTP and referral code
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className={cn(
                          ...
                          form.formState.errors.otp && "border-red-500 focus:border-red-500 focus:ring-red-500/30"
                        )}
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className={cn(
                          "w-full h-12 text-lg bg-white border-frog8-primary/20 focus:border-frog8-primary focus:ring-1 focus:ring-frog8-primary/30 transition-all",
                          form.formState.errors.referralCode && "border-red-500 focus:border-red-500 focus:ring-red-500/30"
                        )}
                      />
